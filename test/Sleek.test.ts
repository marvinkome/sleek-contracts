...
describe("Payment", () => {
  ...
  beforeEach(async () => {
    const PaymentFactory = await ethers.getContractFactory("Sleek");
  ...
  it("deploys contract", async () => {
    ...
    const customerBalance = await stableCoin.balanceOf(
  ...
  describe("Make withdrawals", () => {
    it("can't withdraw without funds", async () => {
      const sellerAddress = await seller.getAddress();
      const withdrawTx = payment
        .connect(deployer)
        .withdrawFunds(
          sellerAddress,
          stableCoin.address,
    ...
    it("can withdraw stable coin", async () => {
      ...
      const withdrawTx = await payment
        .connect(deployer)
        .withdrawFunds(sellerAddress, stableCoin.address);
